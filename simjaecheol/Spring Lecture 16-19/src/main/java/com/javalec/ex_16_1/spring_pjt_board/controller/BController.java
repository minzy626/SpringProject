package com.javalec.ex_16_1.spring_pjt_board.controller;
...
import com.javalec.ex_16_1.spring_pjt_board.command.BCommand;
import com.javalec.ex_16_1.spring_pjt_board.command.BContentCommand;
import com.javalec.ex_16_1.spring_pjt_board.command.BDeleteCommand;
import com.javalec.ex_16_1.spring_pjt_board.command.BListCommand;
import com.javalec.ex_16_1.spring_pjt_board.command.BModifyCommand;
import com.javalec.ex_16_1.spring_pjt_board.command.BReplyCommand;
import com.javalec.ex_16_1.spring_pjt_board.command.BReplyViewCommand;
import com.javalec.ex_16_1.spring_pjt_board.command.BWriteCommand;
...
public class BController { //전체적인 작업을 지휘한다.
	...
	@RequestMapping("/list")
	public String list(Model model) { //컨트롤러 -> 서비스객체 -> dao -> dto
