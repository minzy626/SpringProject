...
<html>
  ...
  <section id="container" >
	...
	<div class="row">
		<div class="col-sm-6">
			<h2>회원가입약관</h2>
			<textarea readonly rows="10" cols="40" style="resize:none;font-size:20px">어우름은 대학생을 대상으로 각종모임(스터디모임, 공모전모임, 동아리모음)을 위하여 운영되는 사이트입니다. 
			</textarea>
		</div>

		<div class="col-sm-6">
			<h2>개인정보처리방침안내</h2>
			<textarea readonly rows="10" cols="40" style="resize:none;font-size:20px">다음 개인정보취급방침에 동의하셔야 어우름 사이트 이용이 가능합니다.
