      ...
      *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 전공 스터디 게시판
				</h3>
				<div class="row mt">
					<div class="col-lg-12">
							...
							<section id="unseen">
								<table
									...
									<c:forEach items="${listNotice}" var="dto">
										...
										<c:forEach items="${list_Smajor}" var="dto">
											<tr class="listToChange">
												<th scope="row" class="text-center">${dto.bId}</th>
												<td><a
													href="/ex/list_Smajor${bPage.makeQuery(1)}&bSearchType=${bPage.sdto.bSearchType}
 ...
 -->
								...
								<div class="dataTables_paginate paging_simple_numbers text-center"
									...
									<ul class="pagination highlight">
										...
										<c:choose>
											<c:when test="${bPage.prev}">
												<li class="paginate_button previous" id="example1_previous">
													<a href="/ex/list_Smajor${bPage.makeSearch(bPage.bStartPage-1)}">
														Previous </a>
												</li>
											</c:when>
											<c:otherwise>
												<li class="paginate_button previous disabled"
													...
													href="/ex/list_Smajor${bPage.makeSearch(bPage.bStartPage-1) }">
														Previous </a></li>
										...
										<li class="page-item">
										<a class="page-link" href="/ex/list_Smajor${bPage.makeSearch(bPage.sdto.bPage-1)}" aria-label="before">
										...
										<c:forEach var="idx" begin="${bPage.bStartPage}"
											...
											<li class="paginate_button active"><a class="page-link"
												href="/ex/list_Smajor${bPage.makeSearch(idx)}"> ${idx} </a></li>
											</c:when>
											<c:otherwise>
										...
										<li class="page-item">
										<a class="page-link" href="/ex/list_Smajor${bPage.makeSearch(bPage.sdto.bPage+1)}" aria-label="after">
										...
										<c:choose>
											<c:when test="${bPage.next}">
												<li class="paginate_button next" id="example1_next"><a
													href="/ex/list_Smajor${bPage.makeSearch(bPage.endPage+1)}">
														Next </a></li>
											</c:when>
											<c:otherwise>
												<li class="paginate_button next disabled" id="example1_next">
													<a href="/ex/list_Smajor${bPage.makeSearch(bPage.endPage+1)}">
														Next </a>
												</li>
											</c:otherwise>
										</c:choose>
	...
	self.location = "/ex/list_Smajor${bPage.makeQuery(1)}&bSearchType="
