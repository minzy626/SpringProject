      ...
      *********************************************************************************************************************************************************** -->
      ...
      <link rel="stylesheet" href="assets/css/write.css"/>
		...
		<br>연락처 : </br>
			  ...
			  <div class="form-group">
	          <div class="col-md-6">
	          	<a href="/ex/index" class="btn btn-warning pull-right"><span class="glyphicon glyphicon-remove"></span> 취소</a>
	          	<button type="submit" id="specificBtn" class="btn main-btn pull-right"  OnClick="javascript:submitContents(); javascript:writeCheck(); return false;"><span class="glyphicon glyphicon-ok-sign"></span> 작성 완료</button>
	          </div>
	          </div>
			</form>
		</div>
